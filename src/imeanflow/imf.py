...
def generate(variable, model, rng, n_sample, config,
             num_steps, omega, t_min, t_max, sample_idx=None, labels=None):
    """
    ...
    Args:
        ...
        labels: Optional (n_sample,) int32 array of class labels. When
                provided, overrides the label assignment from sample_idx.
