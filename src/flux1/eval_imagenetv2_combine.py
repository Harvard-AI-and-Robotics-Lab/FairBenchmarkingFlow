"""Combine shards from parallel FLUX.1 [dev] generation and run metrics against ImageNetV2 matched-frequency."""
...
def main():
    ...
    print("=" * 60)
    print("Loading real ImageNetV2 matched-frequency reference images...")
    print("=" * 60)
